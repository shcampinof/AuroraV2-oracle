...
- Mantener Docker Compose como mecanismo oficial de despliegue. La prueba con Node.js solo debe citarse como validacion temporal cuando Docker no este disponible. Ver `documentacion/documentacion_tecnica/GUIA_DESPLIEGUE_AURORA.md`.
