...
| `documentacion/soporte/` | Documentos técnicos previos. |
...
| `documentacion/soporte/pruebas/SET_PRUEBAS_AURORA.md` | Evidencia de validación y pruebas. |
...
La documentacion detallada esta en `documentacion/soporte/operacion/15_pwa_operacion_offline.md`.
...
La guía detallada está en `documentacion/soporte/operacion/16_cargas_staging_etl_bd.md`.
...
- Mantener `documentacion/soporte/pruebas/SET_PRUEBAS_AURORA.md` como bitácora de validación.
