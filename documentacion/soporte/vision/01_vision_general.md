...
- Cargas mensuales: archivos Excel hacia staging Oracle (`PONAL`, `SISIPEC`, `AURORA_10`) mediante `scripts/cargas_bd/loader_service.py`.
...
- Mantener actualizada la documentacion de cargas mensuales en `documentacion/soporte/operacion/16_cargas_staging_etl_bd.md`.
