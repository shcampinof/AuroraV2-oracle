...
El script `backend/scripts/test-db/setup-test-db.js` crea las 12 tablas documentadas en `documentacion/documentacion_tecnica/base_datos/DICCIONARIO_MODELO_DNDP.html` y carga datos semilla controlados para pruebas de integracion:
