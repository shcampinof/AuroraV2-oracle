...
- Segun `documentacion/documentacion_tecnica/base_datos/DICCIONARIO_MODELO_DNDP.html`, `GESTION_JURIDICA` ya no contiene campos de defensor/PAG; esa informacion se centraliza en `ASIGNACION`.
